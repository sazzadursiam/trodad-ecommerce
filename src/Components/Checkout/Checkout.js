...
const Checkout = () => {
    ...
    try {
      axios
        ...
        .then((res) => {
          ...
          localStorage.setItem("cartTotal", res.data.cartOrderTotal);
  ...
  const updateQuantityPlus = (id, qty) => {
    ...
    axios
      ...
      .then((res) => {
        console.log(res.data);
        CartDetails();
        // console.log(res.data.cartOrderTotal);
      });
  };
  ...
  const formSubmit = (e) => {
    ...
    formdata.append("totalAmount", cartTotals + shippingInfo?.shippingPrice);
    formdata.append("shippingMethod", shippingInfo?.shippingMethod);
    formdata.append("shippingPrice", shippingInfo?.shippingPrice);
  ...
  return (
    <div>
      ...
      <div className="checkout main_section">
        <Container>
          {cartDetails.length != 0 ? (
              ...
              <div className="shopping_cart my-5">
                ...
                <div className="in_total">
                  <div className="calculation btm_border_dash">
                    <div className="d-flex justify-content-between align-items-center btm_border_dash">
                  ...
                  <p className="mb-1">9.70 kr</p>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <p className="mb-1">{shippingInfo?.shippingPrice} kr</p>
                    </div>
                  </div>
                  <div className="d-flex justify-content-between align-items-center">
                    <p className="mb-1 fw-bold fs20">Total</p>
                    <p className="mb-1 fw-bold fs20">
                      {Number(cartTotals + shippingInfo?.shippingPrice).toFixed(
                        2
                      )}{" "}
                      kr
                    </p>
            ...
            <div style={{ minHeight: "50vh" }}>
              <h1 className="my-5 text-danger">Cart is Empty</h1>
            </div>
          )}
        </Container>
      </div>
