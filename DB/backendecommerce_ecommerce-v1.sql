...
--
-- Host: localhost:3306
-- Generation Time: Jul 02, 2022 at 04:30 AM
...
(3, 'a522edc6-7794-46b0-968d-84be5ebb72e5', 'Not-Reg', 13, 1, 1, 34.99, 34.99, '2022-07-02 11:53:31', '2022-07-02 11:53:31');
...
INSERT INTO `orders` (`id`, `customerId`, `name`, `email`, `country`, `streetAddress`, `apartmentAddress`, `city`, `district`, `postCode`, `phone`, `orderStatus`, `paymentType`, `paymentStatus`, `shippingMethod`, `shippingPrice`, `totalAmount`, `created_at`, `updated_at`) VALUES
(1, 1, 'Rafi', 'ashraf.shazed@gmail.com', 'Bangladesh', 'South Bishil, Mirpur - 1', '187', 'Dhaka', 'Dhaka', '1216', '01521204084', 0, 'Cash On Delivery', 'Pending', 'test', 5, 54.19, '2022-07-02 11:49:54', '2022-07-02 11:49:54');
...
(1, 1, 18, 1, 1, 49.19, 49.19, '2022-07-02 11:49:54', '2022-07-02 11:49:54');
...
CREATE TABLE `product_ratings` (
  ...
  `ratingUserEmail` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ratingComments` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `product_ratings` (`id`, `rating`, `ratingUserEmail`, `ratingComments`, `ratingUser`, `productId`, `status`, `created_at`, `updated_at`) VALUES
(1, 3, 'rafi@gmail.com', 'Very Good', 'Rafi', 17, 1, '2022-06-27 14:46:12', '2022-06-27 14:51:42'),
(2, 2, NULL, 'Very Bad', 'Rafi 1', 17, 1, '2022-06-27 14:52:37', '2022-06-27 14:53:05');
...
CREATE TABLE `shippings` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `shippingMethod` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shippingDetails` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shippingPrice` double NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `shippings` (`id`, `shippingMethod`, `shippingDetails`, `shippingPrice`, `created_at`, `updated_at`) VALUES
(1, 'test', '<p><span style=\"color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: justify; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;\">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</span><br></p>', 5, '2022-06-29 18:46:05', '2022-07-02 11:01:52');
...
(1, 'Mr. Rafi', 'user@gmail.com', '01521204084', 'Bangladesh', 'Road- 5 , South Bishil, Mirpur - 1', '187', 'Dhaka', 'Dhaka', '/Images/user/profile/1656422586.png', '1216', NULL, '$2y$10$n0kPtQxkf5UimhCMJUY3jeOkjABHyZrucpIG2EBcwJDBG7hsEIxou', NULL, '2022-06-26 16:55:36', '2022-06-28 17:23:06');
